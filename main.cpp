...
{
	unsigned char shellcode[] ="\xdb\xd9\xbe\x95\x2c\x95\x21\xd9\x74\x24\xf4\x5f\x29\xc9\xb1"      //simple shellcode that pops calc.exe(kindly check if its x64 or x32)
